...
2.1. Após finalizar o processo anterior um terminal será exibido dentro do Cloud9, faça uma cópia do [repositório de configuração do ambiente](https://github.com/fiapdevops/kube-class) da disciplina;
...
```sh
chmod +x ~/environment/kube-class/cloud9/scripts/*.sh

~/environment/kube-class/cloud9/scripts/config.sh
```
